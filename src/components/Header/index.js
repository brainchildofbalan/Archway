...
const Header = () => {
  return (
      <header className='w-full py-[2rem] fixed left-0 top-0 bg-[#fff]'>
          <div className="container">
              <div className="w-full flex justify-between">
                  ...
                  <div className="w-auto flex justify-between">
                      ...
                      <div className="w-[6rem] h-[6rem] rounded-full overflow-hidden bg-[#000] flex justify-center items-center"></div>
                  </div>
              </div>
          </div>
    </header>
