...
const HomeIntro = () => {
  ...
  useGSAP(
    (ctx, ctxSafe) => {
      ...
      pinTimeline.to([".image-1", ".image-3"], {
      ...
      pinTimeline.to(
        [".first", ".second", ".last", ".image-scale"],
        { x: 0, duration: 1 },
        "-=.5"
      );
      pinTimeline.to(".image-scale", { scale: 1, duration: 1.3 });
      pinTimeline.to(".image-scale-wrap", { x: 0, duration: 1.3 }, "<");
    },
    { scope: containerRef }
  );
  return (
    <section className="w-full mt-[-300vh] relative z-1" ref={containerRef}>
      <div className="pinner h-[100vh] z-[2]">
        <div className="w-full relative h-[100vh] flex items-center overflow-hidden z-[2]">
          <div className="container">
            <div className="w-full relative">
              <div className="w-full flex flex-col">
                <div className="w-auto flex flex-wrap -mx-[4.35rem]">
                  <div className="w-1/3 px-[4.35rem] group relative">
                    <div className="w-full text-[#fff] aspect-[437/706] bg-[#000] overflow-hidden relative translate-y-[80vh] will-change-transform image-1">
                      <Image
                        ...
                        fill
                      />
                      <div className="absolute left-0 top-0 w-full h-full scale-[1.1] opacity-0 text-[6rem] will-change-transform font-semibold group-hover:scale-100 group-hover:opacity-100 transition-all duration-500 overflow-hidden">
                        <MovingAnimCard />
                      </div>
                    </div>
                  </div>
                  <div className="w-1/3 px-[4.35rem] group relative">
                    <div className="w-full text-[#fff] aspect-[437/706] bg-[#000] overflow-hidden relative translate-y-[-90vh] will-change-transform image-2">
                      <Image
                  ...
                  <div className="w-1/3 px-[4.35rem] group relative">
                    <div className="w-full text-[#fff] aspect-[437/706] bg-[#000] overflow-hidden relative translate-y-[70vh] will-change-transform image-3">
                      <Image
            ...
            <div className="w-full relative">
              <div className="w-full flex flex-col">
                <h4 className="text-[20.3rem] leading-[1.26] uppercase font-medium">
                  <span className="w-full flex whitespace-nowrap opacity-0 first">
                    Crafting
                  </span>
              ...
              <div className="w-full absolute left-0 top-1/2 -translate-y-1/2 translate-x-[14%] image-scale-wrap">
                <span className="w-full block aspect-[395/211] overflow-hidden relative rounded-[10rem] bg-[#eeee] will-change-transform scale-[.23] image-scale">
                  <video
                    src="https://cdn.prod.website-files.com/648de60e4084b58c01620e50/64ac0edfa68322c8ab4bf395_1-transcode.mp4"
